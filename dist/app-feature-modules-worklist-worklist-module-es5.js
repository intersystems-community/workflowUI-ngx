(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-feature-modules-worklist-worklist-module"], {
    ...
    function srcAppFeatureModulesWorklistWorklistServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _assets_config_config_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ../../../../assets/config/config.json */
      "./src/assets/config/config.json");

      var _assets_config_config_json__WEBPACK_IMPORTED_MODULE_1___namespace = /*#__PURE__*/__webpack_require__.t(
      /*! ../../../../assets/config/config.json */
      ...
      var WorklistService = /*#__PURE__*/function () {
        ...
        _createClass(WorklistService, [{
          ...
          value: function getTasks() {
            return this._http.get("".concat(_assets_config_config_json__WEBPACK_IMPORTED_MODULE_1__["REST_API_URL"], "/tasks"));
          }
        }, {
          key: "getTask",
          value: function getTask(id) {
            return this._http.get("".concat(_assets_config_config_json__WEBPACK_IMPORTED_MODULE_1__["REST_API_URL"], "/task/").concat(id));
          }
        }, {
          key: "saveTask",
          value: function saveTask(task) {
            return this._http.post("".concat(_assets_config_config_json__WEBPACK_IMPORTED_MODULE_1__["REST_API_URL"], "/task/").concat(task.id), task);
          }
        }]);
      ...
      WorklistService.ɵfac = function WorklistService_Factory(t) {
        return new (t || WorklistService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]));
      };

      WorklistService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](WorklistService, [{
